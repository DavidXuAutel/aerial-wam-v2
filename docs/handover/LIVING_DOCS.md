...
| **1b** | [`RUNBOOK_v4.md`](../../experiments/aerial/RUNBOOK_v4.md) | **执行入口**：前提链 P0→P8（**下一步 = P4**；**P0c / P2 接线 / P6 DONE**；**P1 FAIL**；**P3 FAIL** ⓪b/⓪c、⓪f PASS 但 `[lo,hi]` 未冻；**P3.5 = N/A**）。判据看提案 §4.6。机上状态 [`V4_RUNBOOK_125_STATUS.md`](V4_RUNBOOK_125_STATUS.md) |
