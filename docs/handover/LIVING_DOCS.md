...
| **1b** | [`RUNBOOK_v4.md`](../../experiments/aerial/RUNBOOK_v4.md) | **执行入口（08-20 新建；同日实施进度已更新）**：前提链 P0→P8（**下一步 = P3**；**P0c / P2 接线 / P6 DONE**；**P1 FAIL** 仅 reward、修走 P4.5；**P3.5 = N/A**）、四信号执行口径、**§3 跑前冻结 16 项**（spare=`--spare-count 16` 已签）、**§4 必须实测 13 项**、落盘契约、下车站、红线。**判据定义不看本文件，看提案 §4.6**。执行机状态另见 [`V4_RUNBOOK_125_STATUS.md`](V4_RUNBOOK_125_STATUS.md) |
