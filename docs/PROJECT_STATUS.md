...
**✅ V0 / V1 均已 merge PASS。**  
**当前：V4-MVP** — A.3 = **`b3_le_a`**（匹配幅度下 RH 仍偏好 π 后向向量）。**先修 RH**；「§4 充分」不成立。  
...
| **V4** | A.3 **`b3_le_a`** → ⏳ **先修 RH（另案）**；In 表 [待签字](handover/V4_SIGNAL1_STRUCTURAL_REFREEZE_PROPOSAL.md) **不充分**；`enable_policy_update` 仍 false |
